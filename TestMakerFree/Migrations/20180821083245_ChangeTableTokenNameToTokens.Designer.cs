...
namespace TestMakerFreeWebApp.Migrations
{
    ...
    [Migration("20180821083245_ChangeTableTokenNameToTokens")]
    partial class ChangeTableTokenNameToTokens
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestMakerFreeWebApp.Models.Token", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TestMakerFreeWebApp.Models.AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TestMakerFreeWebApp.Models.Token", b =>
                {
                    b.HasOne("TestMakerFreeWebApp.Models.AppUser", "AppUser")
                        .WithMany("Tokens")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
